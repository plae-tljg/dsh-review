...
/** A JSON number parameter (the hunk-context size). */
function numberParameter(name, typeSymbol) {
  return {
    name,
    wire: name,
    source: 'json',
    codec: { mode: 'strict', typeSymbol, schema: z.number() },
  }
}
  ...
  invocations: [
    ...
    },
    {
      ...
      parameters: [
        ...
        numberParameter('context', 'dsh-review/host/types#ReviewContext'),
      ],
      cancellation: { parameter: 'signal' },
      result: {
        mode: 'strict',
